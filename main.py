...
parser.add_argument('--data_root_dir', type=str,
                    default="/run/user/1128299809/gvfs/smb-share:server=rds.icr.ac.uk,share=data/DBI/DUDBI/DYNCESYS/OlgaF/multi_magnification_project/camelyon_data/feats_256/",
                    help='data directory')
...
parser.add_argument('--task', type=str, choices=['task_1_tumor_vs_normal',  'task_2_tumor_subtyping', 'task_3_lipoma', 'clam'])
...
if args.task == 'task_1_tumor_vs_normal':
    ...
    args.n_classes=2
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/clam.csv',
...
if args.split_dir is None:
    ...
    args.split_dir = os.path.join(args.split_dir)
